...
%that are sent to an online ROS network
...
%After it was proved that the Point Cloud Library could be used together with OpenCV library in the same software, the integration of the ROS system started.
