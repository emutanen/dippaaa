...
\begin{subfigure}
    \centering
    \includegraphics[width=.4\linewidth]{harris_feature_detector_left.jpg}
    \caption{Left camera Harris corner detector result.}
    \label{fig:harris_features_left}
\end{subfigure}
\begin{subfigure}
    \centering
    \includegraphics[width=.4\linewidth]{harris_feature_detector_right.jpg}
    \caption{Right camera Harris corner detector result.}
    \label{fig:harris_features_right}
\end{subfigure}
\caption{Harris corner detection can be used to solve the stereo correspondence problem in a stereo setup.}
