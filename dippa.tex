...
Point cloud data quality indicators are important in e.g. modeling of urban constructed environments and in airborne LIDAR mapping. In these fields, the quality evaluation is done separately for spatial structural analysis and positioning of point clouds for registration schemes. The need for different quality indicators depends on the application at hand, but the constructed industrial environment encourages to try suitability of spacial structure analysis in indoor crane environment, too. \ref{Feng08}.\par
Some point cloud data quality metrics can be found in literature, such as spatial structure analysis methods and positioning value for registration schemes. Normally these methods are used in modeling of urban constructed environments and in airborne LIDAR mapping, which \ref{Feng08}.\par
