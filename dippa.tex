...
\ra{1.3}
\caption{Results for left camera calibration using MATLAB Camera Calibration Toolbox.}
\begin{tabular}{@{}lcc@{}}\toprule
Left camera calibration results\\
\midrule
Focal length &  $f_x$ & 470.5395 \\
 & $f_y$ & 470.0528 \\
Principal point & $u_0$ & 361.4851 \\
 & $v_0$ & 297.1134 \\
Skew coefficient & $\alpha$ & 0.0000 \\
