...
back to 3d world coordinates, which solves the 3d reconstruction problem. The quality of the disparity map depends on the selected block matching algorithm, and on disparity tuning parameters. The disparity tuning parameters include 10 parameters that are discussed more in Section \ref{section:parameter_tuning_evaluation}.



were tuned using a visualisation that was controlled with tuner sliders. The parameter tuning 
