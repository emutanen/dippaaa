...
Some point cloud data quality metrics can be found from literature, such as spatial structure analysis methods and positioning goodness in registration schemes \ref{Feng08}. Normally these methods are used in modeling of urban constructed environments and in airborne LIDAR mapping, which means they should be suitable for measuring constructed objects in indoor environments, too.\par
