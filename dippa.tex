...
&x_p = f_{x}\Big(x_{d}(1)+\alpha_{c}*x_{d}(2)\Big)+pp_{x} \\
&y_p = f_{y}x_{d}(2)+pp_{y}
\end{empheq}

The intrinsic calibration parameters were computed using the Camera Calibration Toolbox for MATLAB by Jean-Yves Bouguet. The calibration of the HIMMELI cameras follow the notation and the workflow of the calibration procedure described in \ref{Heikkila97}.
