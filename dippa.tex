...
The camera CMOS mono sensor is manufactured by NIT and has a pixel size of 10$\micro$ m and an optical size of 5.75 mm x 7.68 mm. It has a colour depth of 12 bits, and the dynamic range of the camera is logarithmic with a 120dB sensitivity\ref{IDSImagingWeb13}.
