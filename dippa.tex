...
A three-dimensional object-centered representation is suggested favourable to a pixel-based intensity image representation to improve description of objects. It is suggested that this can be achieved in three steps where
