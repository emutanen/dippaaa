...
A lot of time was used for preparing the online implementation of the load detection software running on top of the ROS operating system. The software currently uses quite simple implementation, but most of the simplicity incurs using the PCL library. In fact, there are optimized, and very advanced algorithms running in the background 


\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=\textwidth]{taakan_tunnistus1.png}
    \caption{Cylindrical load detection in the FAMOUS software using very low quality scenery input data.}
    \label{fig:load_detection1}
  \end{center}
\end{figure}
