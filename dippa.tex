...
where C is a 3 x 4 matrix called the camera matrix, and \tilde{Q} and \tilde{P} are the homogenous image plane projection and 3d object surface point coordinates, respectively.
