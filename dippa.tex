...
Cranes have been used as long as people have been lifting heavy items to elevated locations, and have been trading across the seas in far away locations. In the history, many 

Sometimes, cranes are being used for loading and unloading of goods transported in ships and vessels

%relocating => loading and unloading
%construction => hoisting and lowering

Modern day goods are mostly transported from one location to another in a shipping container unit, such as a standard dry storage unit, or possibly a tank or a cylindrical drum depending on the actual product. The focus of our work is on measuring the dimensions of industrial goods being lifted and moved from e.g. a cargo unloading bay to a storage space.

Industrial goods mean large items that are carried using process hall cranes, such as beams, engines, large coils, cylinders of dangerous goods, 
