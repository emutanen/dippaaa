...
From a technical point of view, a perfect tracking of an object in space and time is difficult, but if an understanding of the model of the object and its qualities is formed, then an estimate of the current state of the model can be used when decision making is needed. With such information, tracks of objects can continuosly provide information about object's location, dimensions, and moving speeds. With this model information it is possible to add collision avoidance functionality to a crane working environment. 
