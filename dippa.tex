...
\section{Lidars And Radars And Sonars}
\label{section:lidars_and_radars_and_sonars}
...
\section{Point Cloud Representations}
\label{section:point_cloud_representations}
+ possible algorithms: clustering, water-filling, and convex hull computations

\subsection{3d Scene Representation}
\label{subsection:3d_scene_representation}
