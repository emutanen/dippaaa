...
Other machine vision applications in crane environments include remote localisation of the end effector \citep{Hainsworth04}, stereoscopic teleoperation of forestry cranes\citep{Westerberg08}, 

The installation of a stereo camera pair in an overhead crane trolley may also be used for other purposes, such as warehouse surveillance, recording of lifting operations, operations tracking, and quality control. For example, training videos can be recorded for new operators or additional information can be recovered in case of accidents.

The load object measurement statistics could be used to keep track of the crane usage and possibly lead to improvements in warehouse layout, or help a factory manager decide upon investing in a larger manufacturing floor if the capacity is at a limit.
