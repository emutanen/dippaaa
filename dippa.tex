...
\centering
\ra{1.3}
\caption{Block matching parameters used in the overhead process crane case. Parameters reported from ?.}
...
\bottomrule
\end{tabular}
\label{table:bm_parameters_overhead} %label just after caption
\end{table}

\begin{table}
\centering
\ra{1.3}
\caption{Block matching parameters used in the forestry crane case. Parameters reported from a forest case dataset 1377169118 on February 25th 2014.}
\begin{tabular}{@{}ll@{}}\toprule
Block matching parameter & Value\\
\midrule
Pre-filter size & 9 \\
