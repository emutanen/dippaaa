...
\begin{algorithm}
\KwData{cylinder segmentation inlier point cloud $P$}
\KwResult{cylinder end point coordinates}
1. compute vector that is N units long along the main cylinder axis so that all data points in point cloud $P$ project on it\;
...
4. initialise two end points $L_1$ and $L_2$ that represent distance along the cylinder main axis starting from start point $S$ along the cylinder main axis\;
