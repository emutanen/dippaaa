...
The pinhole camera geometry is introduced in Figure \ref{fig:pinhole_camera}. A 3d object located at a distance of $p$ from the camera lens (pinhole is an approximation of a thin lens system) is imaged upside down on a 2d image plane $\pi$. An optical axis $I_o$ (dashed line in Figure \ref{fig:pinhole_camera}, positive Z direction in the camera frame $O_c$) lies perpendicularly to the image plane pointing towards the object. The 3d coordinate P on the surface of the object is transformed onto the image plane as image point Q. The ratio of distances $p$ and $q$ is controlled by the lens law 
...
are less illuminated on the borders of the image due to the law of cosines.


$f$ is the focal length of the camera

The pinhole camera geometry will lead to introduction of a camera model matrix M, 
