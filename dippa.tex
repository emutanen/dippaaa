...
In a simple stereo camera configuration the depth can be calculated purely from the geometry if the intrinsic camera parameters are known. 

\begin{equation}
\mathsf{depth} = \frac{\mathfs{baseline * focal length}}{\mathfs{disparity}}
\end{equation}
