...
Today, the modern sea cargo handling process is highly automated, but the manually operated cranes still remain less automated and less profitable. It seems that lifting operations could become more efficient with added automation in spaces where manual operation is still used.
...
Manual EOT crane or boom movement may suffer from non-optimized route selection, operator fatigue, damage to goods in collisions, safety issues for other workers, and other problems that are caused by an operator. 
