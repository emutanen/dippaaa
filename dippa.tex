...
HIMMELI carries two GigE uEye UI-5120 RE HDR cameras in its camera module. The uEye camera is a high dynamic range camera with a CMOS sensor array in PAL resolution 768 x 576 pixels. The model currently in use carries a monochrome sensor that outputs the image at 50 frames per second natively.

The dynamic range of the camera is logarithmic with a 120dB sensitivity. \cite{IDSImagingWeb13}

\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=\textwidth]{camera-gige-ueye-se-cmos-1.jpg}
