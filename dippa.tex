...
Measuring goods while they are being moved and processed at the industrial site is the very basis for all quality control: RFID tags are used to identify and control a batch of products in bulk manufacturing, video systems measure process quality in a paper factory, and spectral analyzer measures the concentration of foreign substances in a soda bottle washing process. On the other hand, some industries are not profitable unless a certain speed of moving goods is reached, such as forestry log picking and tree felling.

While fast, optimized, profitable and safe system examples can be found in some fields, many industrial ventures still rely on manual movement of a product in a factory floor. Now, the 
