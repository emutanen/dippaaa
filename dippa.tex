...
\begin{figure}%
    \centering
    \parbox{5cm}{\includegraphics[width=\linewidth]{segmentation_on_velodyne.jpg}}%
    \qquad
    \begin{minipage}{5cm}%
    \includegraphics[width=\linewidth]{velodyne_original.jpg}
    \end{minipage}%
    \caption{Results on object segmentation from LIDAR scanner data using PCL nearest neighbour search implementation.}
