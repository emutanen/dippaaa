...
\begin{figure}%
    \centering
    \parbox{3cm}{\includegraphics[width=.7\linewidth]{harris_feature_detector_left.jpg}}%
    \qquad
    \begin{minipage}{3cm}%
    \includegraphics[width=0.7\linewidth]{harris_feature_detector_right.jpg}
    \end{minipage}%
    \caption{A rectified image pair.}
