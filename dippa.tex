...
\item u_0 = u coordinate for the optical axis intersection on the image plane
\item v_0 = v coordinate for the optical axis intersection on the image plane
\end{itemize}
