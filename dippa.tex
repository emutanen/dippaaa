...
A glimpse in the not so distant history reveals much more interesting development of another type of a hoisting crane system: the overhead crane, or more commonly known as the bridge crane. Overhead cranes support a beam-like traveling  bridge that is spanning the gap between two rails and the hoisting mechanism is installed on a trolley beneath the traveling bridge. The first mass manufactured overhead cranes systems were commissioned starting from 1876 in England, and nowadays they are widely used in heavy industry for efficient process lifting and service duties.

The development of the electric overhead traveling crane




+is most often installed inside a warehouse for lifting purposes, or sometimes outside for small-scale lifting in e.g. docks and train depots.
