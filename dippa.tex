...
Some problems in cylinder segmentation were encountered due to the fact that the load object point cloud contains the rotary crane boom. The estimator easily fitted the cylinder model on the crane boom and not on the load object, which was an incorrect result. To prevent selection of wrong data, a set of simple heuristic checks were implemented in the software.
