...
Geometric parameter estimation, or also known as geometric fitting, is a technique for estimating parameter models in unordered data sets. The parameter model is usually a pre-defined model, such as a model of a plane or a cylinder, whose location is searched in the data set by finding inliers and outliers that determine whether the data set supports the specific model or not.
