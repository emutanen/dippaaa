...
We have followed the definition of Sonka et al. \cite{Sonka07} so that the resulting camera calibration matrix is an upper triangle matrix containing three unknown parameters $a$, $b$, and $c$ for shearing and rescaling. The equation for the affine transformation of projected point $U_c$ is
