...
If a world point $X_w$ is translated and rotated into the camera coordinate system it will be transformed to point $X_c$. Next, the point will be projected onto the image plane \pi according to the pinhole camera model. Poin $X_c$ projects onto the image plane as Euclidean point $U_c$ where
