...
The extrinsic parameters of the camera interact with the world coordinate system. Since the camera's position lie in some arbitrary world coordinates X and its orientation changes the detected scene accordingly we can easily see that the extrinsic camera parameters change when the camera pose changes in the world coordinate system. Additionally, the world lighting conditions and weather affect the extrinsic parameters to some extent.
...
+ extrinsic axes => scene axes
+ intrinsic axes => camera axes
