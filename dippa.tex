...
The eigen vectors of the load object point cloud can be computed, and the OBB perimeter can be oriented along the largest eigen vector in a right-hand normalised coordinate system. The computation can be done using PCL \emph{moment of inertia and eccintricity based descriptors} module, which is only supported by PCL versions 1.7 and higher.
