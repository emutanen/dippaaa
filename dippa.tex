...
The C++ software source code is not shown in this chapter, because it was done as part of the FAMOUS project, and as such it is not publicly available. Fortunately, an interested reader can find the same functionality from the PCL tutorials available at \citep{PCLTutorials14}.
