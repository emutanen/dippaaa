...
\begin{table}
\caption{Device and its connector type in HIMMELI platform.}
...
A widely accepted right-handed coordinate system will be used for describing a three-dimensional coordinate system. The details will be further discussed in the following sections. In general, the positive Z axis points out towards the viewer in a two-dimensional image plane.
...
The world has its own coordinate system, namely $(X,Y,Z)$ coordinate system.
