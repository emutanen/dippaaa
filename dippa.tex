...
\newcommand{\KEYWORDS}{stereo machine vision, crane load object, environment mapping}
\newcommand{\FKEYWORDS}{stereokonenäkö, nosturin taakka, ympäristön kartoitus}
\newcommand{\SKEYWORDS}{stereomaskinseende, kran last, miljö kartläggning}
