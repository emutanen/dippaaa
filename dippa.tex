...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.5\textwidth]{enlarging_effect.jpg}
...
Finally, the hoisting wires output a clearly visible point cloud response, which means they will be included in the load object bounding volume. Inclusion of the hoisting wires is not preferable, and should be counteracted using heuristics. From the bird's eye viewpoint, it is possible to model the hoisting wires correctly.
