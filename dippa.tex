...
and it relates the image reference frame and the camera reference frame so that

\begin{equation}
\label{eq:image_ref_frame_relation_to_camera_ref_frame}
\begin{array}{c}\lbrack
x_p \\
y_p \\
1\rbrag\end{array}=K\begin{array}{c}\lbrack
x_{d} \\
y_{d}\rbrag\end{array}
\end{equation}
