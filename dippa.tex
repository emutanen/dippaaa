...
\begin{equation}
\textbf{\tilde{p_1}^T} \textbf{F} \textbf{\tilde{p_2}} = 0
\label{eq:fundamental_matrix}
\end{equation}

where $\tilde{p_1}$ and $\tilde{p_2}$ are the projected image points expressed in homogenous coordinates. The line equations for the epipolar lines are solved using the fundamental matrix so that epipolar line $l_1$ is 

\begin{equation}
l_1 = \textbf{F} \textbf{\tilde{p_1}}
\label{eq:epipolar_line_1}
\end{equation}

and the epipolar line $l_2$ is 

\begin{equation}
l_2 = \textbf{F} \textbf{\tilde{p_2}}
