...
Overhead cranes are used for medium to heavy lifting, 



in heavy process industry, and in warehouse solutions for heavy lifting. For example, in steel mills, heavy lifting is needed when cylinders of molten steel or other metal are carried to the next process station. Also the moving of finished products such as large iron beams requires heavy lifting that only an overhead crane can carry out. 
