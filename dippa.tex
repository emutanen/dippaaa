...
Focal length is a 2x1 vector that reports the linear focal length components for projection of the final pixel coordinates $x_p$ and $y_p$. Principal point is a 2x1 vector that reports the intersecting point of the optical axis and the image plane.
