...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{The effect of parameters P1 and P2 in SGBM algorithm tuning. Values of P1 and P2 increase from left to right, and from top to bottom.}
...
The tuning of the BM parameters was done using datasets from all camera configurations. High saliency image regions were used for tuning since they produced good point responses in most cases.
