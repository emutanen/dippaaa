...
In the forestry crane environment the installation of the Himmeli platform is even more constrained by spatial limitations. In an actual log picker truck the options would include the operator booth rooftop and the base of the rotary crane boom. Thus, in testing situation the Himmeli platform was installed in two locations: near the base plate of the rotary crane boom, and on the rooftop of the operator booth.
