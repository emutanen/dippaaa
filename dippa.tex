...
A possible way of preventing manually operated lifted goods from colliding with the nearby environment would be interactive control where duality is used in control: While the operator executes the initial hoisting and designs the trajectory of the moving action, a computer interactively recalculates the trajectory with an optimal control scheme. The computer controller provides feedback of the current state of the operations so that the operater may adjust his or her working style interactively. 
